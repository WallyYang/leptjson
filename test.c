...
#define TEST_STRING(expect, json)                                       \
    do {                                                                \
        ...
        lept_init(&v);                                                  \
        EXPECT_EQ_RESULT(LEPT_PARSE_OK, lept_parse(&v, json));          \
        EXPECT_EQ_TYPE(LEPT_STRING, lept_get_type(&v));                 \
...
#pragma GCC diagnostic ignored "-Wformat"
    ...
    lept_init(&v);
    EXPECT_EQ_RESULT(LEPT_PARSE_OK, lept_parse(&v, "[ null , false , true , 123 , \"abc\"]"));
    EXPECT_EQ_TYPE(LEPT_ARRAY, lept_get_type(&v));
    ...
    lept_init(&v);
    EXPECT_EQ_RESULT(LEPT_PARSE_OK, lept_parse(&v, "[ [ ] , [ 0 ] , [ 0 , 1 ] , [ 0 , 1 , 2 ]]"));
    EXPECT_EQ_TYPE(LEPT_ARRAY, lept_get_type(&v));
    EXPECT_EQ_SIZE_T(4, lept_get_array_size(&v));

    EXPECT_EQ_TYPE(LEPT_ARRAY, lept_get_type(lept_get_array_element(&v, 0)));
    EXPECT_EQ_SIZE_T(0, lept_get_array_size(lept_get_array_element(&v, 0)));

    EXPECT_EQ_TYPE(LEPT_ARRAY, lept_get_type(lept_get_array_element(&v, 1)));
    ...
    EXPECT_EQ_TYPE(LEPT_ARRAY, lept_get_type(lept_get_array_element(&v, 2)));
    ...
    EXPECT_EQ_TYPE(LEPT_ARRAY, lept_get_type(lept_get_array_element(&v, 3)));
...
#pragma GCC diagnostic ignored "-Wformat"
    ...
    lept_init(&v);
    EXPECT_EQ_RESULT(LEPT_PARSE_OK, lept_parse(&v, " { } "));
    EXPECT_EQ_TYPE(LEPT_OBJECT, lept_get_type(&v));
    ...
    EXPECT_EQ_TYPE(LEPT_NULL,   lept_get_type(lept_get_object_value(&v, 0)));
    EXPECT_EQ_STRING("f", lept_get_object_key(&v, 1), lept_get_object_key_length(&v, 1));
    EXPECT_EQ_TYPE(LEPT_FALSE,  lept_get_type(lept_get_object_value(&v, 1)));
    EXPECT_EQ_STRING("t", lept_get_object_key(&v, 2), lept_get_object_key_length(&v, 2));
    EXPECT_EQ_TYPE(LEPT_TRUE,   lept_get_type(lept_get_object_value(&v, 2)));
    EXPECT_EQ_STRING("i", lept_get_object_key(&v, 3), lept_get_object_key_length(&v, 3));
    EXPECT_EQ_TYPE(LEPT_NUMBER, lept_get_type(lept_get_object_value(&v, 3)));
    ...
    EXPECT_EQ_TYPE(LEPT_STRING, lept_get_type(lept_get_object_value(&v, 4)));
    ...
    EXPECT_EQ_TYPE(LEPT_ARRAY, lept_get_type(lept_get_object_value(&v, 5)));
    ...
    for (i = 0; i < 3; i++) {
        ...
        EXPECT_EQ_TYPE(LEPT_NUMBER, lept_get_type(e));
    ...
    EXPECT_EQ_STRING("o", lept_get_object_key(&v, 6), lept_get_object_key_length(&v, 6));
    {
        ...
        EXPECT_EQ_TYPE(LEPT_OBJECT, lept_get_type(o));
        for (i = 0; i < 3; i++) {
            ...
            EXPECT_EQ_TYPE(LEPT_NUMBER, lept_get_type(ov));
...
static void test_parse_invalid_value() {
    ...
    TEST_PARSE_ERROR(LEPT_PARSE_INVALID_VALUE, "ture");
    TEST_PARSE_ERROR(LEPT_PARSE_INVALID_VALUE, "fals");
...
static void test_parse_missing_quotation_mark() {
    ...
    TEST_PARSE_ERROR(LEPT_PARSE_MISS_QUOTATION_MARK, "{\"a:1,");
}
...
#define TEST_EQUAL(json1, json2, equality)                       \
    do {                                                         \
        ...
        lept_init(&v1);                                          \
        lept_init(&v2);                                          \
        EXPECT_EQ_RESULT(LEPT_PARSE_OK, lept_parse(&v1, json1)); \
        EXPECT_EQ_RESULT(LEPT_PARSE_OK, lept_parse(&v2, json2)); \
...
static void test_move() {
    ...
    lept_init(&v3);
    lept_move(&v3, &v2);
    EXPECT_EQ_TYPE(LEPT_NULL, lept_get_type(&v2));
...
static void test_access_number() {
    ...
    EXPECT_EQ_DOUBLE(lept_get_number(&v), 1.5);
    lept_free(&v);
}
